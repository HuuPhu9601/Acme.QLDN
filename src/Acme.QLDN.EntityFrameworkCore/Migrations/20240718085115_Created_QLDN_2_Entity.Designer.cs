...
{
    [DbContext(typeof(QLDNDbContext))]
    [Migration("20240718085115_Created_QLDN_2_Entity")]
    partial class Created_QLDN_2_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.QLDN.Managers.Manager", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Acme.QLDN.OrgStaffs.OrgStaff", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppOrgStaffs", (string)null);
                });

            modelBuilder.Entity("Acme.QLDN.OrgUnits.OrgUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("OrgUnitParentId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppOrgUnits", (string)null);
                });

            modelBuilder.Entity("Acme.QLDN.Staffs.Staff", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.QLDN.OrgStaffs.OrgStaff", b =>
                {
                    b.HasOne("Acme.QLDN.OrgUnits.OrgUnit", "OrgUnit")
                        .WithMany("OrgStaffs")
                        .HasForeignKey("OrgUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.QLDN.Staffs.Staff", "Staff")
                        .WithMany("OrgStaffs")
            ...
            modelBuilder.Entity("Acme.QLDN.OrgUnits.OrgUnit", b =>
                {
                    b.HasOne("Acme.QLDN.Managers.Manager", "Manager")
                        .WithMany("OrgUnits")
